...
weight_path = "model/train_1912_e02_vl0.64413.hdf5" # or "model/weight_light.json"

image_path = 'sample images/original images/23 original.png' # put the path of the image that you convert.
